    ...
    >
      <div className="space-y-5">
        ...
        <form action={saveSettingsAction} className="space-y-5">
          <div className="panel p-5">
            ...
            <div className="mt-4 grid gap-5 lg:grid-cols-2">
              <div>
                <label className="mb-2 block text-sm font-medium">Voting start datetime</label>
                <input
                  type="datetime-local"
              ...
              <div>
                <label className="mb-2 block text-sm font-medium">Voting end datetime</label>
                <input
                  type="datetime-local"
                  name="voting_end_at"
        ...
        <div className="panel p-5">
          ...
          <form action={resetEventDataAction} className="mt-4 sm:max-w-sm">
